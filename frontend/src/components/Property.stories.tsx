...
const mainstreamProperty: Properties_properties = {
  ...
  image: 'https://www.rightmove.co.uk/news/wp-content/uploads/2018/07/Oak-Lane-Sevenoaks-Kent-image-1-768x512.jpg',
  saved: false,
  bed: 4,
  price:  500000,
  roi: 17.2,
...
storiesOf('Property', module)
  .add('with title and price', () => <Property actions={actions} property={mainstreamProperty} />)
  .add('with saved', () => <Property actions={actions} property={{...mainstreamProperty, saved: true}} />);
